...
class M171114123452Add_backend_menu extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $id = (new Query())->select(['id'])->from('{{%admin_menu}}')->where(['name' => 'App管理', 'parent' => 8])->scalar($this->getDb());
    ...
    {
        echo "M171114123452Add_backend_menu cannot be reverted.\n";
